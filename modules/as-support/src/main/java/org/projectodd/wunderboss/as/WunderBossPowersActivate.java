...
public class WunderBossPowersActivate implements ServiceActivator {
    @Override
    public void activate(ServiceActivatorContext serviceActivatorContext) throws ServiceRegistryException {
        Module module = Module.forClass(WunderBossPowersActivate.class);
        ...
        MSCService service = new MSCService(deploymentName,
                                                    serviceActivatorContext.getServiceRegistry(),
                                                    serviceActivatorContext.getServiceTarget(),
                                                    namingContext);
        serviceActivatorContext.getServiceTarget()
                .addService(MSCService.serviceName(deploymentName), service)
